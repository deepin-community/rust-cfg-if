...
cfg-if - program to do something

# SYNOPSIS

**cfg-if** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**cfg-if** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **cfg-if** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**cfg-if** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    cfg-if. See **foo.conf**(5) for further details.
...
**cfg-if** provides some return codes, that can be used in scripts:
